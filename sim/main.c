...
// Note: In a real build, you'd include the actual UI files
// For now, we'll create a minimal UI for testing
...
int main(int argc, char **argv) {
    ...
    // Initialize UI
    // Uncomment when UI files are properly linked:
    // ui_init();
    
    // For now, create a demo UI
    create_demo_ui();
